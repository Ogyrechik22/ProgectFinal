...
def setup():
    ...
    textMode(CENTER)
def draw():
    global x,y,z,l,s,dirs,dira,dirb,dirc,dird,ee,bb,cc,dd,rr,vv
    background(1)
    fill(54,255,0)
    textSize(20)
    ellipse(bb,ee,35,35)
...
def mouseClicked():
    ...
    fill(255)
    textSize(30)
    text(u"Уровень от Knobelboy. Сложность 8/10. Играть!",100,50)
    text(u"Уровень от ItsDolphy Сложность 6/10. Играть!",100,125)
    text(u"Уровень от Trusta. Сложность 4/10. Играть!",100,200)
    text(u"Уровень от Smiffy777. Сложность 1/10. Играть!",100,275)
    ...
    text(u"Уровень от ItsVeryZGD. Сложность 2/10. Играть!",100,725)
    text(u"Уровень от Manix. Сложность 5/10. Играть!",100,800)
    text(u"Уровень от Eandis. Сложность 7/10. Играть!",100,875)
